    ...
    public class AppiumSetup
    {
        ...
        public static void RunBeforeAnyTests(TestContext context)
        {
            var androidOptions = new AppiumOptions
            {
                ...
                // App = Path.Join(TestContext.CurrentContext.TestDirectory, "../../../../MauiApp/bin/Release/net9.0-android/com.lumoin.verifable-Signed.apk"),
            ...
            androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.lumoin.verifable");

            //Make sure to set [Register("com.companyname.basicappiumsample.MainActivity")] on the MainActivity of your android application
            androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.lumoin.verifable.MainActivity");
